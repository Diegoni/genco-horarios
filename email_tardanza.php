	...
	<div class="col-md-12" id="scrollit">
		<div class="panel panel-default">
			<div class="panel-body" id="muestra">
				...
				$mensaje	.= "<thead>";	
				$mensaje	.= "<tr>";	
				$mensaje	.= "<th>Empleado</th>";	
				$mensaje	.= "<th style='text-align: center'>Día</th>";	
				$mensaje	.= "<th style='text-align: center'>Fecha</th>";
				$mensaje	.= "<th style='text-align: center'>Marcación</th>";
				$mensaje	.= "<th style='text-align: center'>Tiempo</th>";
				$mensaje	.= "<th style='text-align: center'>Tipo</th>";
				$mensaje	.= "</tr>";
				$mensaje	.= "</thead>";
				$mensaje	.= "<tbody>"; 
					...
					if($cantidad_marcacion>0){
						do{
							...
							if($tardanza['tiempo']!=0){
								...
								$mensaje	.= "<tr>";									
								$mensaje	.= "<td>".$row_usuario2['usuario']."</td>";
								$mensaje	.= "<td><p class='dia'>".devuelve_dia(date('Y/m/d', strtotime($row_marcacion['entrada'])))."</p></td>";
								$mensaje	.= "<td><p class='".$clase."' title='".$title."'>".date('d/m/Y', strtotime($row_marcacion['entrada']))."</p></td>";
								$mensaje	.= "<td style='text-align: center'>".date('H:i', strtotime($row_marcacion['entrada']))."</td>";
								$mensaje	.= "<td style='text-align: center'>".pasar_hora($tardanza['tiempo'])."</td>";
								$mensaje	.= "<td><p class='".$parametro['clase']."' title='".$parametro['title'].$tardanza['parametro']."'>".$parametro['cadena']."</p></td>";
								$mensaje	.= "</tr>";
							}
