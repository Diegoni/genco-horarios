	...
	<div class="col-md-9" id="scrollit">
		<div class="panel panel-default">
			...
			<div class="panel-body" id="muestra">
				<?php do{ ?>
					<a name="seccion<?php echo $row_usuario2['id_usuario']?>"></a>
					<div class="slidingDiv <?php echo $row_usuario2['id_usuario']?>">
						<?php 
						if(isset($_GET['buscar'])){?>
							
							<a href="#" ><h3><?php echo $row_usuario2['usuario']?></h3></a>
							
							<button class="btn btn-default pull-right" onclick="tableToExcel('example<?php echo $row_usuario2['id_usuario']?>', '<?php echo $row_usuario2['usuario']?>')">
